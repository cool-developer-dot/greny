...
const mockProjects: VerificationProject[] = [
  {
    ...
    expectedCO2Reduction: 125000,
    submittedDate: '2024-02-15',
    status: 'Pending Verification',
    submittedBy: 'Dr. Maria Silva',
  },
  {
    id: '2',
    projectName: 'Solar Energy Farm Development',
    ngoName: 'Green Energy Foundation',
    location: 'California, USA',
    methodology: 'Renewable Energy - Solar PV',
    expectedCO2Reduction: 85000,
  ...
  },
  {
    ...
    methodology: 'Blue Carbon - Mangrove Protection',
    expectedCO2Reduction: 95000,
  ...
  {
    id: '4',
    projectName: 'Wind Power Generation Project',
    ngoName: 'Clean Air Initiative',
    location: 'Scotland, UK',
    methodology: 'Renewable Energy - Wind Power',
    expectedCO2Reduction: 110000,
          ...
          <div className="lg:col-span-1 space-y-4">
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-4 sm:p-6">
              ...
              <p className="text-sm text-gray-600 mb-4">
                {mockProjects.filter(p => p.status !== 'Verified' && p.status !== 'Rejected').length} project(s) awaiting review
              </p>
              ...
              <div className="space-y-3 max-h-[calc(100vh-300px)] overflow-y-auto">
                {mockProjects.map((project) => (
                  ...
                  >
                    ...
                    <p className="text-xs sm:text-sm text-gray-600 mb-2">{project.ngoName}</p>
                    ...
                    <div className="mt-2 pt-2 border-t border-gray-200">
                      <div className="text-xs text-gray-600">
                        ...
                        <span className="text-green-600 font-bold">
                          {project.expectedCO2Reduction.toLocaleString()} tCO₂
                        </span>
                      </div>
                    </div>
                  </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                  <div className="bg-gradient-to-r from-green-500 to-emerald-500 px-6 py-4">
                    ...
                    <p className="text-green-100 text-sm">{selectedProject.ngoName}</p>
                  </div>
                  ...
                  <div className="p-6">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                      ...
                      <div>
                        <label className="text-xs font-semibold text-gray-500 uppercase tracking-wide">Methodology</label>
                        <p className="text-sm font-semibold text-gray-900 mt-1">{selectedProject.methodology}</p>
                      </div>
                      <div>
                        <label className="text-xs font-semibold text-gray-500 uppercase tracking-wide">Expected CO₂ Reduction</label>
                        <p className="text-lg font-bold text-green-600 mt-1">
                          {selectedProject.expectedCO2Reduction.toLocaleString()} tCO₂
                        </p>
                      </div>
                      <div>
                        <label className="text-xs font-semibold text-gray-500 uppercase tracking-wide">Submitted By</label>
                        <p className="text-sm font-semibold text-gray-900 mt-1">{selectedProject.submittedBy}</p>
                      </div>
                      <div>
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
                  ...
                  {selectedProject.status === 'Verified' && (
                    <div className="mt-6 pt-6 border-t border-gray-200">
                      <button className="w-full px-6 py-3 bg-gradient-to-r from-blue-500 to-indigo-500 text-white font-bold rounded-xl hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2">
                        <span>📜</span>
