...
type ProjectStatus = 'Draft' | 'Under Review' | 'Verified';
...
interface Project {
  ...
  location: string;
  methodology: string;
  expectedCO2Reduction: number; // in tonnes
...
const mockProjects: Project[] = [
  {
    id: '1',
    projectName: 'Urban Solar Panel Initiative',
  ...
  {
    id: '2',
    projectName: 'Reforestation Program - Amazon',
    location: 'Manaus, Brazil',
    methodology: 'Forest Restoration',
  ...
  {
    id: '4',
    projectName: 'Wind Energy Farm Development',
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
          <div className="px-6 py-4 bg-gradient-to-r from-gray-50 to-gray-100 border-b border-gray-200">
            ...
            <p className="text-sm text-gray-600 mt-1">
              {mockProjects.length} project{mockProjects.length !== 1 ? 's' : ''} total
            </p>
          </div>
              ...
              >
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                  ...
                  <div className="flex items-center gap-3 flex-shrink-0">
                    <button className="px-4 py-2 text-sm font-semibold text-green-600 hover:bg-green-50 rounded-lg transition-colors border border-green-200">
                      View Details
                    </button>
